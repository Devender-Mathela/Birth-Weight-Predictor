...
@app.route('/')
def home():
    return render_template('10index.html')
...
def get_prediction():
    ...
    #get data from user
    baby_data_form=request.form #form data will store here

    baby_data_cleaned=get_cleaned_data(baby_data_form)

    baby_df=pd.DataFrame(baby_data_cleaned)  #convert into dataframe
    ...
    return render_template("10index.html",prediction=prediction)
